...
async function carregarItem() {
  ...
  try {
    ...
    montarVisaoGeral(item); montarConteudoCompleto(item); montarEtapas(item); montarMateriais(item); montarImagens(item); montarAnotacoes(item); ativarAbas(); conteudo.hidden = false;
